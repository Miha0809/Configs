...
# Golang
alias openbp="docker compose -f docker-compose.dev.yml up --build"
alias tests="go clean -testcache && DB_URL=\"pgx://postgres:postgres@127.0.0.1:5432/postgres\" NATS_URL=\"nats://127.0.0.1:4222\" GIN_MODE=\"test\" go test --tags=file2llm_feature_ocr_tesseract,file2llm_feature_pdf,test -p 1 ./..."
